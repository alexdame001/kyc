...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2>RICO Dashboard - Pending KYC Requests</h2>
        ...
        <a href="{{ route('rico.reports') }}" class="btn btn-info btn-lg">View Reports</a>
    </div>
    ...
    <form method="GET" class="mb-4 d-flex gap-2">
        ...
        @if(request('search'))
            <a href="{{ route('rico.dashboard') }}" class="btn btn-secondary">Clear</a>
        @endif
    </form>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-warning text-dark">
                                {{ ucfirst($form->rico_status ?? 'pending') }}
                            </span>
                        </td>
